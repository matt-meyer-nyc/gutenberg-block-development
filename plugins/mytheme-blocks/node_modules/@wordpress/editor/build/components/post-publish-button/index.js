...
function (_Component) {
  ...
  function PostPublishButton(props) {
    ...
    _this.createIgnoredForSave = (0, _memize.default)(function (postType, postId) {
      return new _equivalentKeyMap.default([[['postType', postType, String(postId)], true]]);
    }, {
      maxSize: 1
    });
    return _this;
  ...
  (0, _createClass2.default)(PostPublishButton, [{
    ...
    value: function render() {
      ...
      return (0, _element.createElement)(_element.Fragment, null, (0, _element.createElement)(_entitiesSavedStates.default, {
