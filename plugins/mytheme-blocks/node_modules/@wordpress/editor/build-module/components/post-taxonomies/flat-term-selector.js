...
function (_Component) {
  ...
  function FlatTermSelector() {
    ...
    _this.searchTerms = throttle(_this.searchTerms.bind(_assertThisInitialized(_this)), 500);
    _this.findOrCreateTerm = _this.findOrCreateTerm.bind(_assertThisInitialized(_this));
    _this.state = {
