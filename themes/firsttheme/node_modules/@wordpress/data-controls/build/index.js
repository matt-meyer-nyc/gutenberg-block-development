  ...
  SELECT: (0, _data.createRegistryControl)(function (registry) {
    return function (_ref2) {
      ...
      var storeKey = _ref2.storeKey,
          ...
          args = _ref2.args;
      return (_registry = registry[registry.select(storeKey)[selectorName].hasResolver ? '__experimentalResolveSelect' : 'select'](storeKey))[selectorName].apply(_registry, (0, _toConsumableArray2.default)(args));
    };
  }),
